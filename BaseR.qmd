...
Creating data frame.
```{r}
bp_df <- data.frame(patients = names(prebp), pre_bp = prebp, post_bp = postbp, diff_bp = diffbp)
```
...
```{r}
bp_df2 <- data.frame(patients = names(prebp2), pre_bp = prebp2, post_bp = postbp2, diff_bp = diffbp2)
```
